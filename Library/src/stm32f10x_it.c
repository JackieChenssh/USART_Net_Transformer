...
* Return         : None
*******************************************************************************/
extern volatile u16 USART_RecLen;
extern volatile u16 USART_RecLenSum;
extern u8 USART_Recbuf[ETH_MTU];
void USART1_IRQHandler(void)
{
	...
	{	
		...
		USART_RecLen = ETH_MTU - DMA_GetCurrDataCounter(DMA_Channel5);
		USART_RecLenSum += USART_RecLen;
		DMA_SetCurrDataCounter(DMA_Channel5,ETH_MTU); 
